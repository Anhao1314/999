// Frozen snapshot of the schema the v0B3 milestone shipped (commit d073bc7).
//
// Assembled from the shipped v0B3 `store.mjs` SQL constants and migration
// statements exactly as they are written there — the v4 → v5 migration test
// must open a *real* v4 database, not a re-derivation of one. If a later
